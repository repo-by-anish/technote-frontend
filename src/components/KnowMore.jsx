...
const KnowMore = () => {
    return (
        <section>
            ...
            <p className="welc">Welcome to our school! <span className="highlight">We are excited to introduce you to all the amazing things our school has to offer.</span></p>
            <ul>
